    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-narrow text-center">
        ...
        >
          ...
          >
            We craft spaces that inspire, endure, and elevate the human
            experience. Architecture is not just about buildings—it's about
            creating moments where concrete, light, and shadow work in perfect
            harmony.
          </motion.p>
